...
# load the data, ignore all comment lines started w. #
xa_high = np.loadtxt('data/xa_high_food.csv', comments = '#')
xa_low = np.loadtxt('data/xa_low_food.csv', comments = '#')

# make the bin boudary
...
#plt.show() # it may cause an empty file when saved because it shows, turns off,
              # then saves an empty file in pdf later.
